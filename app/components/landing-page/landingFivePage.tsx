            ...
            <>
                <div className="m-8 lg:m-24">
                    ...
                    <div className="flex flex-row justify-center">
                        <div className="hidden lg:block bg-cover bg-center lg:flex flex-col mt-10 lg:justify-center lg:w-[820px] lg:h-[752px] 2xl:w-[1280px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/tari.png')] relative">
                        ...
                        <div className="lg:mx-12 grid grid-cols-1 gap-1 md:grid md:grid-cols-2 md:gap-1 lg:grid lg:grid-cols-1 gap-1">
                            ...
                            <div className=" sm:mx-0 md:mx-8 lg:mx-0 bg-cover bg-center  lg:flex flex-col mt-10 lg:justify-center lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/kuliner.png')] relative">
                            ...
                            <div className="bg-cover bg-center lg:flex flex-col mt-4 lg:justify-center lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/wanita.png')] relative">
                            ...
                            <div className="sm:mx-0 md:mx-8 lg:mx-0 bg-cover bg-center lg:flex flex-col mt-4 lg:justify-center w-[250px] lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/festival.png')] relative">
