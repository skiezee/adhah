            ...
            <>
                <div className="m-8 lg:m-24">
                    ...
                    <div className="flex flex-row justify-center">
                        <div className="animate-fade-right animate-once animate-duration-[1500ms] hidden lg:block bg-cover bg-center lg:flex flex-col mt-10 lg:justify-center lg:w-[820px] lg:h-[752px] 2xl:w-[1280px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/tari.png')] relative">
                            <div className="bg-[#3A170D] rounded-tl-2xl rounded-tr-2xl absolute inset-x-0 bottom-0 flex flex-row items-end justify-between">
                                ...
                                <Link href='/detail-seni-tari' className="my-auto mr-8">
                                    <Image src='/arrow-right.svg' alt="arrow" width={17} height={29} />
                                </Link>
                        ...
                        <div className="animate-fade-up animate-once animate-duration-[1500ms] lg:mx-12 grid grid-cols-1 gap-1 md:grid md:grid-cols-2 md:gap-1 lg:grid lg:grid-cols-1 gap-1">
                            <div className="block lg:hidden bg-cover bg-center  lg:flex flex-col mt-10 lg:justify-center  lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/tari.png')] relative">
                            ...
                            <div className="animate-fade-left animate-once animate-duration-[1500ms] sm:mx-0 md:mx-8 lg:mx-0 bg-cover bg-center  lg:flex flex-col mt-10 lg:justify-center lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/kuliner.png')] relative">
                            ...
                            <div className="animate-fade-up animate-once animate-duration-[1500ms] bg-cover bg-center lg:flex flex-col mt-4 lg:justify-center lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/wanita.png')] relative">
                            ...
                            <div className="animate-fade-left animate-once animate-duration-[1500ms] sm:mx-0 md:mx-8 lg:mx-0 bg-cover bg-center lg:flex flex-col mt-4 lg:justify-center w-[250px] lg:w-[400px] h-[240px] bg-white rounded-2xl overflow-hidden shadow-lg bg-[url('/festival.png')] relative">
