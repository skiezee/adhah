...
const LandingSecTentangKami = () => {
    return (
        <>
            {/* bagian kedua landing */}
            <div className="flex flex-row justify-center -mt-12 lg:mt-16 p-16 max-width-[100%]">
                <div className="flex flex-col">
                    <div className="bg-[#FFFFFF] w-[100%] mx-auto w-[300px] mt-8 sm:w-[500px] md:w-[700px] lg:w-[925px] h-[220px] lg:h-[575px] rounded-2xl shadow-2xl flex flex-col justify-center">
                    ...
                    <div className="flex justify-center lg:justify-start mt-6 lg:mt-12 max-width: 100%">
                ...
                <Image src='/terasering-responsive.png' alt="gunung" width={680} height={427} className="block lg:hidden mx-auto mt-8 w-[300px] sm:w-[600px] md:w-[680px]"/>
                </div>


                <div className="max-width: 100% lg:ml-[-15%] mt-24 z-10 relative flex items-center">
...
export default LandingSecTentangKami